...
아주 아주 단순한 그리디! <br>
그냥 앞 뒤로 체육복을 빌려줄 여력이 있는지 확인한다. <br>
그러기 위해서 일단 정렬을 한 다음에 set에 넣어 주었다. <br>
그리고 문제에서 제시된 예외적인 상황의 처리를 위해 여분의 체육복이 있는 학생들은 set들에서 전부 빼 주었다. <br>
이제 체육복을 빌려야 하는 학생들이 각자 앞 뒤를 순서대로 확인해서 체육복을 빌리면 끝
