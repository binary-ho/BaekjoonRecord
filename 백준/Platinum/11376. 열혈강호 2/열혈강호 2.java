...
public class Main {
    ...
    public static final int SIZE = 2_005;
    ...
    * */
    ...
    private static void solve() throws IOException {
        ...
        for (int i = 0; i <= Math.max(workCount, workerCount * 2); i++) {
            if (edges[i] == null) {
        ...
        for (int worker = 1; worker <= workerCount; worker++) {
            ...
            for (int i = 0; i < workerWorkCount; i++) {
                ...
                edges[worker + workerCount].add(work);
            }
        }
        ...
        * */
        int answer = 0;
        for (int worker = 1; worker <= workerCount * 2; worker++) {
