...
솔직히 조금 어이 없는 문제 <br>
처음 부터 아이디어는 맞았다. 굳이 새로운 좌표를 찾는 것이 아니라, 두 점 중에 하나 위에 편의 시설이 있다고 생각하고, <br>
그 지점과 가장 먼 지점을 찾아낸 다음, 두 점을 각각 가장 가까운 지점, 가장 먼 지점으로 잡고 문제를 풀어 나가는 것이다. <br>
여기까지는 맞았는데, 지점을 선택하는 순서(?)는 상관 없을 거라고 생각하고 NC2로 풀었다 <br>
무슨 말이냐면, 가장 가까운 점을 A라고 할 때의 가장 먼 점이 B라면, B가 가장 가까운 점으로 선택 되었을 때, 가장 먼 점은 A라고 생각했다. <br>
거의 100%의 확신을 가지고, 나름 예외도 처리하고 넣었는데 틀렸다고 나왔다. <br>
혹시 몰라서 A B와 B A를 다른 경우로 두었더니 맞아버렸다. <br>
처음으로 이왜맞을 당했다. 이왜틀은 자주 있었어도 이왜맞은 처음이였다.. <br>
누워서 찬찬히 생각해보니, 이는 당연히 틀렸다. A, B, C, D와 같은 일자형 배치가 있고 각 지점간 거리는 1m 라고 생각해보자. <br>
벌써 보인다.. B에서 가장 먼 점은 D이지만, D에서 가장 먼 점은 A이다.. 어찌 보면 지극히 당연한 부분인데 왜 놓쳤을까? <Br>
그래도 엄청나게 많은 시간을 고민한 것은 아니라서 다행이다.
